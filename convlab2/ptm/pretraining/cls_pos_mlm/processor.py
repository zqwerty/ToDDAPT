...
class CLSPosMLMDataset(Dataset):
...
class CLSPosMLMProcessor(TaskProcessor):
    ...
    def load_data(self, train_batch_size, dev_batch_size, max_length=256, num_workers=0, use_multiwoz=False):
        ...
        for dataset in self.datasets:
            ...
            dev_dataset = CLSPosMLMDataset(dev_data, self.tokenizer, max_length)
            ...
            if dataset != 'multiwoz25' or use_multiwoz:
                ...
                train_dataset = CLSPosMLMDataset(train_data, self.tokenizer, max_length)
...
if __name__ == '__main__':
    ...
    processor = CLSPosMLMProcessor(['camrest'], tokenizer, mlm_probability=1.0)
