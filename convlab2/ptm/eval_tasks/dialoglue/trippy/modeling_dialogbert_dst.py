...
import sys
from convlab2.ptm.pretraining.model import DialogBertModel, DialogBertPreTrainedModel


class DialogBertForDST(DialogBertPreTrainedModel):
    def __init__(self, config):
        super(DialogBertForDST, self).__init__(config)
